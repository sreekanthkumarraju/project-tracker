...
const Project = (props) => {
  ...
  //     const result = await fetch(`${server}/auth/isLoggedIn`, { method: "GET" });
  ...
  useEffect(() => {
    async function fetchProject() {
      if (!projectDeleted) {
        const result = await fetch(`${server}/projects/projectData/${projectId}`);
        const parsedResult = await result.json();
    ...
    async function fetchTasks() {
      if (!projectDeleted) {
        const result = await fetch(`${server}/projects/${projectId}/tasks`);
        const parsedResult = await result.json();
  ...
  const updateProject = async () => {
    const result = await fetch(`${server}/projects/updateProject/${projectId}`, {
      method: "POST", // or 'PUT'
      headers: {
  ...
  const deleteProject = async () => {
    const result = await fetch(`${server}/projects/deleteProject/${projectId}`, {
      method: "POST",
    });
    const parsedResult = await result.json();
