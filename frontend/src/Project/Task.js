...
const Task = (props) => {
  ...
  const updateTaskText = async (event) => {
    ...
    const result = await fetch(`${server}/projects/updatetasktext`, {
      method: "POST",
      headers: {
  ...
  const updateTimeline = async (event) => {
    ...
    if (timelineSelectedValue) {
      const result = await fetch(`${server}/projects/updateTask`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deleteTask = async () => {
    const result = await fetch(`${server}/projects/deletetask`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
